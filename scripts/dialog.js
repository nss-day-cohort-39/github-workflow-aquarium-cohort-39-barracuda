const initializeDetailButtonEvents = () => {
  ...
  document
    .querySelector("#button--dory")
    .addEventListener("click", theClickEvent => {
      const theDialog = document.querySelector("#details--dory")
      theDialog.showModal()
    })

  // Show barracuda's details when the button is clicked
  document
    .querySelector("#button--barracuda")
    .addEventListener("click", theClickEvent => {
